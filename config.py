...
# Templates da campanha de retargeting (parcelamento/PIX + 5% desconto)
CAMPAIGN_TEMPLATE_SID_BR = os.getenv('CAMPAIGN_TEMPLATE_SID_BR', 'HXb63059dac50469761b4d1b0dde786519')
CAMPAIGN_TEMPLATE_SID_ES = os.getenv('CAMPAIGN_TEMPLATE_SID_ES', 'HX98c934ef566185bf77f1decc08ce11dd')
...
# Horários comerciais
BUSINESS_HOURS = {
    'Brazil': {'start': 9, 'end': 23, 'timezone': 'America/Sao_Paulo'},
